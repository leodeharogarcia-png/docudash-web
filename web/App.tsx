  ...
  return (
    <section className="relative pt-24 pb-4 md:pt-40 md:pb-28 overflow-hidden flex items-center justify-center bg-[#0B0F19]">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute inset-0 bg-[linear-gradient(rgba(255,255,255,0.03)_1px,transparent_1px),linear-gradient(90deg,rgba(255,255,255,0.03)_1px,transparent_1px)] bg-[size:60px_60px] [mask-image:radial-gradient(ellipse_60%_60%_at_50%_50%,#000_70%,transparent_100%)] opacity-40 animate-pulse"></div>
      ...
      <div className="max-w-7xl mx-auto px-4 grid lg:grid-cols-2 gap-8 items-center w-full relative z-10">
        ...
        <div className="relative z-10 mt-6 lg:mt-0 flex flex-col items-center gap-2 lg:gap-6 justify-center w-full">
          ...
          <div className="transform scale-[0.72] sm:scale-[0.85] lg:scale-[0.8] xl:scale-[0.9] origin-center lg:origin-bottom-left transition-transform duration-500 hover:scale-[0.75] sm:hover:scale-[0.88] lg:hover:scale-[0.82] xl:hover:scale-[0.92] -my-8 md:my-0">
